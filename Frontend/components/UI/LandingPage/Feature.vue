                ...
                <div class="w-full space-y-12 lg:w-1/2">
                    ...
                    <div class="md:flex md:items-start md:-mx-4">
                        ...
                        <div class="mt-4 md:mx-4 md:mt-0">
                            ...
                            <p class="mt-3 text-gray-500">
                                Easily onboard, monitor, and manage your IoT devices at scale. Track
                    ...
                    <div class="md:flex md:items-start md:-mx-4">
                        ...
                        <div class="mt-4 md:mx-4 md:mt-0">
                            ...
                            <p class="mt-3 text-gray-500">
                                Gain insights into device performance and behavior with customizable
                                dashboards. Visualize data, identify trends, and make data-driven
                                decisions.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="md:flex md:items-start md:-mx-4">
                        ...
                        <div class="mt-4 md:mx-4 md:mt-0">
                            ...
                            <p class="mt-3 text-gray-500">
                                Seamlessly integrate with existing systems and workflows. Connect
                                with popular platforms, build custom integrations, and automate
                                workflows.
                            </p>
                        </div>
                    </div>
