...
const navigation = ref([
    { title: "Features", router: "#Features" },
    { title: "Pricing", router: "#Pricing" },
    { title: "Testimonials", router: "#Testimonials" },
    { title: "FAQs", router: "#FAQs" }
]);
...
const isSticky = ref(true); // set to true by default
</script>
    ...
    >
        <div class="items-center px-4 max-w-screen-xl mx-auto md:flex md:px-8">
            <div class="flex items-center justify-between py-3 md:py-5 md:block">
                <a :href="externalLinks.home" class="flex mr-4">
