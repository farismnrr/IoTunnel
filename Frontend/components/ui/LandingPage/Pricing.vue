				...
				>
					<div class="p-4 py-8 border-b md:p-8">
						<div class="justify-between flex">
							<div class="max-w-xs">
								<span class="text-2xl text-gray-800 dark:text-white font-semibold sm:text-3xl">
									{{ plan.name }}
								</span>
							...
							<div class="flex-none text-gray-800 dark:text-white text-2xl font-semibold sm:text-3xl">
								${{ plan.price }}
								<span class="text-xl text-gray-600 dark:text-gray-300 font-normal">/mo</span>
							</div>
						</div>
						<button
							class="mt-4 px-3 py-3 rounded-lg w-full font-semibold text-sm duration-150 text-white bg-primary-500 hover:bg-primary-600 active:bg-primary-700"
						>
							Get Started
						</button>
					</div>
					<ul class="p-4 space-y-3 sm:grid sm:grid-cols-2 md:block md:p-8 lg:grid">
						...
						<li
							v-for="(featureItem, idx) in plan.features"
							:key="idx"
