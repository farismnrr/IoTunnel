        ...
        <div class="py-24 sm:py-32">
            <div class="mx-auto max-w-7xl px-6 lg:px-8">
                <div class="mx-auto max-w-2xl sm:text-center">
                    ...
                    >
                        IoTunnel pricing plan
                    </h1>

                    <p class="max-w-2xl mx-auto mt-4 text-center text-gray-500 xl:mt-6">
                        IoTunnel is designed to be simple and flexible. Choose the plan that fits
                        your IoT needs.
                    </p>
                </div>
                <div
                ...
                >
                    <div class="p-8 sm:p-10 lg:flex-auto">
                        ...
                        <p class="mt-6 text-base leading-7 text-gray-600">
                            Unlock unlimited devices, data points, and premium features, including
