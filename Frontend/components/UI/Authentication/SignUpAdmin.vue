...
const signupButton = async () => {
    const authenticationService = AuthenticationService(data.value.internalLinks.signIn, config);
    await authenticationService.adminRegister({
        ...
        admin_key: data.value.formData.adminKey,
