...
const data = ref({
    text: {
        title: "IoTunnel Features",
        deviceManagement: {
            title: "Device Management",
            description:
                "Easily onboard, monitor, and manage your IoT devices at scale. Track device performance, update firmware, and troubleshoot issues remotely."
        },
        realTimeAnalytics: {
            title: "Real-time Data Analytics",
            description:
                "Gain insights into device performance and behavior with customizable dashboards. Visualize data, identify trends, and make data-driven decisions."
        },
        integrations: {
            title: "Integrations",
            description:
                "Seamlessly integrate with existing systems and workflows. Connect with popular platforms, build custom integrations, and automate workflows."
        }
    },
    image: {
            ...
            <div class="lg:flex lg:items-center">
                <div class="w-full space-y-12 lg:w-1/2">
                    ...
                    <div class="md:flex md:items-start md:-mx-4">
                        <span
                            class="inline-block p-2 text-primary-500 bg-primary-100 rounded-xl md:mx-4"
                        >
                            <svg
                        ...
                        <div class="mt-4 md:mx-4 md:mt-0">
                            <h1 class="text-xl font-semibold text-gray-700 capitalize">
                                {{ data.text.deviceManagement.title }}
                            </h1>

                            <p class="mt-3 text-gray-500">
                                {{ data.text.deviceManagement.description }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="md:flex md:items-start md:-mx-4">
                        ...
                        <div class="mt-4 md:mx-4 md:mt-0">
                            <h1 class="text-xl font-semibold text-gray-700 capitalize">
                                {{ data.text.realTimeAnalytics.title }}
                            </h1>

                            <p class="mt-3 text-gray-500">
                                {{ data.text.realTimeAnalytics.description }}
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="md:flex md:items-start md:-mx-4">
                        ...
                        <div class="mt-4 md:mx-4 md:mt-0">
                            <h1 class="text-xl font-semibold text-gray-700 capitalize">
                                {{ data.text.integrations.title }}
                            </h1>

                            <p class="mt-3 text-gray-500">
                                {{ data.text.integrations.description }}
                            </p>
                        </div>
                    </div>
                </div>
