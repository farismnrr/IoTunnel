...
const data = ref({
    ...
    internalIcons: {
        ...
        reportingIcon: "M10.5 6a7.5 7.5 0 107.5 7.5h-7.5V6zM13.5 10.5H21A7.5 7.5 0 0013.5 3v7.5z",
        usersIcon:
...
const deleteAccessToken = async () => {
    ...
    switch (logoutResponse.status) {
        ...
        case "success":
            ...
            navigateTo(data.value.internalLinks.homeUrl);
            break;
    }
};
    ...
    >
        <NuxtLink :to="data.internalLinks.homeUrl">
            <div class="flex items-center space-x-2">
                ...
                <h1 class="text-md font-bold">IoTunnel</h1>
            </div>
        </NuxtLink>
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav class="flex-1 -mx-3 space-y-3">
                <!-- <div class="relative mx-3">
                    <span class="absolute inset-y-0 left-0 flex items-center pl-3">
                        <svg class="w-5 h-5 text-gray-400" viewBox="0 0 24 24" fill="none">
                            <path
                                :d="data.internalIcons.searchIcon"
                                stroke="currentColor"
                                stroke-width="2"
                ...
                >
                    ...
                    >
                        <path
                            :d="data.internalIcons.dashboardIcon"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        />
                    </svg>
                ...
                >
                    ...
                    >
                        <path
                            :d="data.internalIcons.tasksIcon"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        />
                    </svg>
                ...
                <NuxtLink
                    class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-gray-100 hover:text-gray-700"
                    :to="data.internalLinks.reportingUrl"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                    ...
                    >
                        <path
                            :d="data.internalIcons.reportingIcon"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        />
                    </svg>
                ...
                >
                    ...
                    >
                        <path
                            :d="data.internalIcons.usersIcon"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        />
                    </svg>
                ...
                >
                    ...
                    >
                        <path
                            :d="data.internalIcons.settingsIcon"
                            stroke-linecap="round"
                            stroke-linejoin="round"
                        />
                    </svg>
            ...
            <div class="mt-6">
                ...
                <div class="flex items-center justify-between mt-6">
                    <NuxtLink
                        :to="data.internalLinks.userAvatarLink"
